package com.huateng.wxmgr.userbatch.service;
...
public class AccessTokenService {
	...
	private boolean doGetToken() {
		try {
			// 首先向微信服务器发送请求
			JSONObject response = restTemplate.getForEntity(String.format(Constant.GET_ACCESS_TOKEN, appId, appSecret), JSONObject.class).getBody();
