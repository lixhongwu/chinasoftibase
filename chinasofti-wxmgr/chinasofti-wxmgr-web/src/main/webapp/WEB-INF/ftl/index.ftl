    	...
    	<div class="easyui-accordion" data-options="border:false,fit:true"> 
        	<div title="快捷菜单" data-options="iconCls:'icon-application-cascade'" style="padding:5px;">  	
    			<ul class="easyui-tree wu-side-tree" >
                	<li iconCls="icon-drink"><a href="javascript:void(0)" data-icon="icon-chart-organisation" data-link="wxmenu/menugroup" iframe="0">自定义菜单</a></li>
                    <li iconCls="icon-text-signature"><a href="javascript:void(0)" data-icon="icon-users" data-link="temp/layout-3.html" iframe="0">消息管理</a></li>
