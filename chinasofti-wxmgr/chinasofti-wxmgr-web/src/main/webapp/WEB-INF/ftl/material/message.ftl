...
<script type="text/javascript">
	...
	*/
	$('#wu-datagrid').datagrid({
		...
		columns:[[
			{ checkbox:true},
			{ field:'ToUserName',title:'ToUserName',width:100,sortable:true},
			{ field:'FromUserName',title:'FromUserName',width:180,sortable:true},
			{ field:'CreateTime',title:'CreateTime',width:100},
			{ field:'MsgType',title:'MsgType',width:100},
			{ field:'Content',title:'Content',width:100},
			{ field:'MsgId',title:'MsgId',width:100},
	});
</script>