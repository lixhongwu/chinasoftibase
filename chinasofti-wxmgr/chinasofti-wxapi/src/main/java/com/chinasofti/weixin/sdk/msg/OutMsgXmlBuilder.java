...
import com.jfinal.weixin.sdk.msg.out.OutCustomer;
...
public class OutMsgXmlBuilder {
	...
	private static void initStringTemplateLoader(StringTemplateLoader loader) {
		...
		// 多客服消息 
		loader.putTemplate(OutCustomer.class.getSimpleName(), OutCustomer.TEMPLATE);
	}
