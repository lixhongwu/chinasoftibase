/**
 * Copyright (c) 2011-2015, lianghuan  梁欢(lianghuan1314@163.com).
 *
...
public class JsonKit {
     ...
     */
    public static Map<String, String> jsonToHashMap(String object)
    {
	...
	public static void main(String[] args) {
		String ss = "{\"name\":\"admin\",\"retries\":\"3fff\",\"testname\":\"ddd\",\"testretries\":\"fffffffff\"}";
		Map m = jsonToHashMap(ss);
	}
}
